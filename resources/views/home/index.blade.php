    ...
    <div class="preguntas" >
        ...
        <div class="contenedor-preguntas activo" data-categoria="preguntas-generales">
            <div class="contenedor-pregunta">
                <p class="preguntaF">¿Puedo elegir el psicólogo con el que realizaré mi sesión? <img src="assets/img/preguntasFrecuentes/suma.svg" alt="abrir respuesta"></p>
            ...
            <div class="contenedor-pregunta">
                <p class="preguntaF">¿Cómo puedo empezar una sesión? <img src="assets/img/preguntasFrecuentes/suma.svg" alt="abrir respuesta"></p>
                <p class="respuesta"> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias deserunt, doloremque eligendi esse, fuga id illum in ipsam m</p>
            </div>
        </div>
        <!--Metodos de pago-->
        <div class="contenedor-preguntas" data-categoria="metodos-pago">
            ...
            <div class="contenedor-pregunta">
                <p class="preguntaF">¿Que plazos tengo para poder pagar? <img src="assets/img/preguntasFrecuentes/suma.svg" alt="abrir respuesta"></p>
                <p class="respuesta"> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias deserunt, doloremque eligendi esse, fuga id illum in ipsam m</p>
            </div>
        </div>
